"""
Django settings for eventlifyevents project.
...
WSGI_APPLICATION = 'eventlify.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'connect.eventlify@gmail.com'
EMAIL_HOST_PASSWORD = 'lvrjfhzxxlzjttlp'
